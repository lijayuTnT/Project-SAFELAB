  ...
  const translations = {
    en: {
      ...
      careersPage: {
        ...
        roleProductManagerCopy: "Define AI safety products, translate user needs into roadmap priorities, and coordinate cross-functional delivery.",
        roleAgentArchitect: "Agent Architect",
        roleAgentArchitectCopy: "Design agent architectures, evaluation frameworks, tool-use systems, and runtime infrastructure.",
        roleRedTeam: "Red Team Specialist",
        roleRedTeamCopy: "Run red-team testing, attack simulation, and risk validation for agents and large models.",
        roleModelTraining: "Large Model Training",
        roleModelTrainingCopy: "Train and improve large models, guard models, data recipes, alignment pipelines, and evaluation loops.",
        roleOperationsGrowth: "Operations &amp; Growth",
        roleOperationsGrowthCopy: "Lead content operations, community growth, marketing campaigns, and partnership expansion.",
    ...
    zh: {
      ...
      careersPage: {
        ...
        roleProductManagerCopy: "负责 AI 安全产品规划、用户需求梳理、路线图和跨团队推进。",
        roleAgentArchitect: "Agent架构师",
        roleAgentArchitectCopy: "设计 Agent 系统架构、评估框架、工具调用和运行时基础设施。",
        roleRedTeam: "红队职位",
        roleRedTeamCopy: "负责智能体和大模型的红队测试、攻击模拟和风险验证。",
        roleModelTraining: "大模型训练",
        roleModelTrainingCopy: "负责大模型与护栏模型训练、数据配方、对齐和评估优化。",
        roleOperationsGrowth: "运营推广",
        roleOperationsGrowthCopy: "负责内容运营、社区增长、市场推广和合作拓展。",
