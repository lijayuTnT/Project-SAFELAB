(function () {
  const translations = {
    en: {
      ...
      company: {
        ...
        industryLogosAria: "Industry experience logos",
        academicLogosAria: "Academic background logos",
        logoOpenAI: "OpenAI",
        logoGoogle: "Google",
        logoMicrosoft: "Microsoft",
        logoByteDance: "ByteDance",
        logoAlibaba: "Alibaba",
        logoFudan: "Fudan",
        logoTsinghua: "Tsinghua",
        logoStanford: "Stanford",
        logoUCLA: "UCLA",
        logoUSC: "USC",
        ...
        leader1Point2: "15+ years of experience",
        ...
        visionNow: "Now",
        visionPhase1: "PHASE 1",
        visionToday: "Today",
        visionNext: "Next",
        visionPhase2: "PHASE 2",
        visionFuture: "Future",
        visionPhase3: "PHASE 3",
      ...
      careersPage: {
        metaTitle: "Careers - XSafe AI",
        metaDescription: "Open roles and career opportunities at XSafe AI.",
        eyebrow: "CAREERS",
        title: "Why Join XSafeAI",
        reason1Title: "Work on Problems That Matter",
        reason1Copy1: "The safety challenges of future intelligent systems have not yet been solved.",
        reason1Copy2: "As AI systems become increasingly autonomous, new questions emerge around safety, governance, and trust.",
        reason1Copy3: "We are working on them today.",
        reason2Title: "Build From First Principles",
        reason2Copy1: "Many of the systems required for the agentic era do not yet exist.",
        reason2Copy2: "We are building infrastructure for agent evaluation, safety training, runtime defense, and agent governance from the ground up.",
        reason3Title: "Small Team, Large Impact",
        reason3Copy1: "We are an early-stage team where researchers and engineers work closely together.",
        reason3Copy2: "Every contribution directly shapes our products, research, and long-term direction.",
        openRoles: "Open Roles",
        groupEngineering: "Engineering",
        groupResearch: "Research Internships",
        groupOperations: "Operations",
        roleAgentHarness: "Agent Harness Architect",
        roleAgentHarnessCopy: "Design and build infrastructure for large-scale agent evaluation, orchestration, and runtime execution.",
        roleDataScientist: "Data Scientist — Safety Data",
        roleDataScientistCopy: "Build automated systems for generating, collecting, curating, and evaluating large-scale safety datasets.",
        roleTrainingEngineer: "Model Training Engineer",
        roleTrainingEngineerCopy: "Train and optimize guard models and safety-enhanced foundation models.",
        roleAgentSystems: "Agent Systems Engineer",
        roleAgentSystemsCopy: "Build next-generation agent systems for desktop, mobile, and future computing platforms.",
        roleSafetyIntern: "Agent Safety Research Intern",
        roleSafetyInternCopy: "Research agent attacks, defenses, evaluation, and governance.",
        roleMLOpsIntern: "MLOps &amp; Deployment Intern",
        roleMLOpsInternCopy: "Build infrastructure for training, deployment, evaluation, and monitoring.",
        roleTrainingIntern: "Model Training Intern",
        roleTrainingInternCopy: "Support the development of guard models and safety-enhanced foundation models.",
        roleOperations: "Operations &amp; Administration",
        roleOperationsCopy: "Support company operations and growth.",
        roleMarketing: "Marketing &amp; Communications",
        roleMarketingCopy: "Communicate our mission, products, and research to the AI community.",
        roleFinance: "Finance &amp; Accounting",
        roleFinanceCopy: "Support financial operations and long-term company growth.",
        contactTitle: "Interested in joining us?",
        contactCopy: "We'd love to hear from you."
      },
      terms: {
    ...
    zh: {
      ...
      company: {
        ...
        industryTitle: "产业经验",
        academicTitle: "学术背景",
        industryLogosAria: "产业经验标识",
        academicLogosAria: "学术背景标识",
        logoOpenAI: "OpenAI",
        logoGoogle: "Google",
        logoMicrosoft: "Microsoft",
        logoByteDance: "字节跳动",
      ...
      careersPage: {
        metaTitle: "招聘 - XSafe AI",
        metaDescription: "XSafe AI 的开放职位与职业机会。",
        eyebrow: "招聘",
        title: "为什么加入 XSafeAI",
        reason1Title: "解决真正重要的问题",
        reason1Copy1: "未来智能系统的安全挑战仍未被彻底解决。",
        reason1Copy2: "随着 AI 系统越来越自主，围绕安全、治理和信任的新问题不断出现。",
        reason1Copy3: "我们正在今天解决这些问题。",
        reason2Title: "从第一性原理构建",
        reason2Copy1: "智能体时代所需的许多系统尚不存在。",
        reason2Copy2: "我们正在从零构建智能体评估、安全训练、运行时防御和智能体治理基础设施。",
        reason3Title: "小团队，大影响",
        reason3Copy1: "我们是一支早期团队，研究人员和工程师紧密协作。",
        reason3Copy2: "每一份贡献都会直接塑造我们的产品、研究和长期方向。",
        openRoles: "开放职位",
        groupEngineering: "工程",
        groupResearch: "研究实习",
        groupOperations: "运营",
        roleAgentHarness: "智能体评估架构师",
        roleAgentHarnessCopy: "设计并构建大规模智能体评估、编排和运行时执行基础设施。",
        roleDataScientist: "数据科学家 — 安全数据",
        roleDataScientistCopy: "构建用于生成、采集、清洗和评估大规模安全数据集的自动化系统。",
        roleTrainingEngineer: "模型训练工程师",
        roleTrainingEngineerCopy: "训练并优化护栏模型和安全增强基础模型。",
        roleAgentSystems: "智能体系统工程师",
        roleAgentSystemsCopy: "为桌面、移动和未来计算平台构建下一代智能体系统。",
        roleSafetyIntern: "智能体安全研究实习生",
        roleSafetyInternCopy: "研究智能体攻击、防御、评估和治理。",
        roleMLOpsIntern: "MLOps 与部署实习生",
        roleMLOpsInternCopy: "构建训练、部署、评估和监控基础设施。",
        roleTrainingIntern: "模型训练实习生",
        roleTrainingInternCopy: "支持护栏模型和安全增强基础模型的开发。",
        roleOperations: "运营与行政",
        roleOperationsCopy: "支持公司运营和增长。",
        roleMarketing: "市场与传播",
        roleMarketingCopy: "向 AI 社区传达我们的使命、产品和研究。",
        roleFinance: "财务与会计",
        roleFinanceCopy: "支持财务运营和公司的长期增长。",
        contactTitle: "有兴趣加入我们？",
        contactCopy: "我们期待与你交流。"
      },
      terms: {
  ...
  function applyLanguage(language) {
    ...
    document.title = pageTitle ? pageTitle.textContent : translations[nextLanguage].meta.title;
